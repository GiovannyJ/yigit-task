                    ...
                    <table class="table table-bordered no-more-tables" id="eligibleTable">
                        <thead>
                            <tr>
                                ...
                                <th style="vertical-align: text-top;">Employee ID</th>
                                <th style="vertical-align: text-top;">Full Name</th>
                                <th style="vertical-align: text-top;">First Name</th>
                                <th style="vertical-align: text-top;">Last Name</th>
                                <th style="vertical-align: text-top;">Status</th>
                                <th style="vertical-align: text-top;">Position</th>
                                <th style="vertical-align: text-top;">Title</th>
                                <th style="vertical-align: text-top;">Department</th>
                                <th style="vertical-align: text-top;">Department Number</th>
                            </tr>
                        </thead>
                        <tbody>
                            <%
